...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 07, 2023 at 02:31 AM
...
CREATE TABLE `course` (
  ...
  `implementation_year` date NOT NULL DEFAULT current_timestamp(),
...
(300000, 'Programming 1', 15, 0, NULL, '1st Quarter', '2023-03-07', 2000),
(300001, 'Programming 2', 30, 0, 300000, '2nd Quarter', '2023-03-07', 1990),
(300002, 'Object Oriented Programing', 1, 0, NULL, '1st Quarter', '2023-03-07', 1990),
(300003, 'Calculus', 1, 0, NULL, '1st Quarter', '2023-03-07', 2000),
(300004, 'Calculus 2', 1, 0, 300003, '1st Quarter', '2023-03-07', 2000),
(300005, 'Information Management', 1, 0, NULL, '1st Quarter', '2023-03-07', 2010),
(300006, 'Database Administration', 1, 0, 300005, '1st Quarter', '2023-03-07', 2010),
(300007, 'Web Development', 1, 0, NULL, '1st Quarter', '2023-03-07', 2000),
(300008, 'Mathematics', 30, 0, NULL, '1st Quarter', '2023-03-07', 2023),
(300009, 'Arts', 30, 0, NULL, '1st Quarter', '2023-03-07', 2023),
(300010, 'Programming 3', 30, 0, 300001, '1st Quarter', '2023-03-07', 2023),
(300011, 'CHMTC', 14, 0, NULL, '1st Quarter', '2023-03-07', 2023);
...
INSERT INTO `registration_course` (`course_reg_id`, `course_id`, `instructor_id`, `opening_date`, `closing_date`) VALUES
...
(400008, 300008, 700000, '2023-01-01', '2023-01-15'),
(400009, 300009, 700013, '2023-01-01', '2023-01-15'),
(400010, 300000, 700000, '2023-04-01', '2023-04-18'),
(400011, 300001, 700000, '2023-04-01', '2023-04-18'),
(400012, 300010, 700002, '2023-05-01', '2023-05-17'),
(400013, 300011, 700001, '2023-05-01', '2023-05-17');
